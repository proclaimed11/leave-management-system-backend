...
const provisionUser = async (req, res) => {
    try {
        ...
        const must_change_password = body.must_change_password === undefined
            ? undefined
            : Boolean(body.must_change_password);
        const allow_existing = body.allow_existing === undefined ? undefined : Boolean(body.allow_existing);
