...
exports.EmployeeImportValidator = void 0;
...
function isValidCompanyEmail(email) {
    ...
    if (!e.includes("@"))
        return false;
    if (!e.endsWith(COMPANY_EMAIL_DOMAIN))
        return false;
...
class EmployeeImportValidator {
    ...
    roles;
    locations;
    constructor(employees = new employeeRepository_1.EmployeeRepository(), departments = new departmentRepository_1.DepartmentRepository(), roles = new roleReposirory_1.RoleRepository(), locations = new locationRepository_1.LocationRepository() // ✅ ADD
    ) {
    ...
    async validateRow(row) {
        ...
        if (errors.length === 0) {
            ...
            if (!PHONE_REGEX.test(phone)) {
                errors.push({
                    field: "phone",
                    message: "Phone number must be 10 digits and start with 07 or 01 (e.g., 0794375045)",
                });
            }
            // Full name shape
...
exports.EmployeeImportValidator = EmployeeImportValidator;
